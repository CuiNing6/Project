...
from densenet import DenseNetImageNet161, preprocess_input
...
# 定义网络框架
base_model = DenseNetImageNet161(include_top=False, weights='imagenet', input_tensor=None, input_shape=None)

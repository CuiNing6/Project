...
# 数据准备
IM_WIDTH, IM_HEIGHT = 299, 299 #指定的图片尺寸
FC_SIZE = 1024                # 全连接层的节点个数
NB_IV3_LAYERS_TO_FREEZE = 100  # 冻结层的数量
...
# 定义网络框架
base_model = Xception(include_top=False, weights='imagenet', input_tensor=None, input_shape=None) # 预先要下载no_top模型
